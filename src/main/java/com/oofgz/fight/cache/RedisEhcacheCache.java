...
public class RedisEhcacheCache extends AbstractValueAdaptingCache {
    ...
    // 默认的构造函数
    public RedisEhcacheCache(boolean allowNullValues) {
        super(allowNullValues);
    }

    public RedisEhcacheCache(String name,
                             RedisTemplate<Object, Object> redisTemplate,
                             Cache<Object, Object> ehcacheCache,
                             RedisEhcacheProperties redisEhcacheProperties) {
    ...
    public void put(Object key, Object value) {
        if (!super.isAllowNullValues() && null == value) {
            this.evict(key);
            return;
        }
    ...
    public ValueWrapper putIfAbsent(Object key, Object value) {
        ...
        synchronized (key) {
            ...
            if(null == prevValue) {
                ...
                this.ehcacheCache.put(key, toStoreValue(value));
            }
        }
    ...
    public void evict(Object key) {
        ...
        // 避免短时间内如果先清除ehcache缓存后其他请求会再从redis里加载到ehcache中
    ...
    protected Object lookup(Object key) {
        Object cacheKey = getKey(key);
        Object value = this.ehcacheCache.get(key);
        if(null != value) {
